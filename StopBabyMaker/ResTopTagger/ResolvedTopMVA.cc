...
void ResolvedTopMVA::setJetVecPtrs(const std::vector<LorentzVector>* in_p4vec, const std::vector<float>* in_csvvec, const std::vector<float>* in_cvslvec,
                                   const std::vector<float>* in_ptDvec, const std::vector<float>* in_axis1vec, const std::vector<int>* in_multvec) {
  p4vec = in_p4vec;
  csvvec = in_csvvec;
  cvslvec = in_cvslvec;
  ptDvec = in_ptDvec;
