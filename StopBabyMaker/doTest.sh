...
./runBabyMaker stopbaby 1000 3 ./ /hadoop/cms/store/group/snt/run2_mc2018/TTJets_SingleLeptFromT_TuneCP2_13TeV-madgraphMLM-pythia8_RunIIAutumn18MiniAOD-PUFall18Fast_lhe_102X_upgrade2018_realistic_v15-v2_MINIAODSIM_CMS4_V10-02-08/merged_ntuple_1.root 1
./runBabyMaker stopbaby -1 3 ./ /hadoop/cms/store/group/snt/run2_mc2017/SMS-T2tt_mStop-1200to2000_TuneCP2_13TeV-madgraphMLM-pythia8_RunIIFall17MiniAODv2-PUFall17Fast_94X_mc2017_realistic_v15-v1_MINIAODSIM_CMS4_V10-02-05/merged_ntuple_4.root 1

# ./runBabyMaker T2tt_mStop650_mLSP350_a18v1 3000 1 ./ /hadoop/cms/store/user/sicheng/ProjectMetis/SMS-T2tt_mStop-650_mLSP-350_TuneCP2_13TeV-madgraphMLM-pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_MINIAODSIM_CMS4_V10-02-10/merged_ntuple_1.root 0
# ./runBabyMaker stopbaby 1000 1 ./ /hadoop/cms/store/group/snt/run2_mc2018/SMS-TChiWH_WToLNu_HToBB_TuneCP2_13TeV-madgraphMLM-pythia8_RunIIAutumn18MiniAOD-PUFall18Fast_102X_upgrade2018_realistic_v15-v1_MINIAODSIM_CMS4_V10-02-09/merged_ntuple_92.root 1
# ./runBabyMaker stopbaby 10000 1 ./ /hadoop/cms/store/group/snt/run2_mc2018/TTZToLLNuNu_M-10_TuneCP5_13TeV-amcatnlo-pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15_ext1-v2_MINIAODSIM_CMS4_V10-02-04/merged_ntuple_1.root 0 fillZll=true,skim_met_ZllEvt=50,skim_nGoodLep=2
# ./runBabyMaker stopbaby 1000 3 ./ /hadoop/cms/store/group/snt/run2_mc2018/SMS-T2tt_mStop-400to1200_TuneCP2_13TeV-madgraphMLM-pythia8_RunIIAutumn18MiniAOD-PUFall18Fast_102X_upgrade2018_realistic_v15-v2_MINIAODSIM_CMS4_V10-02-08/merged_ntuple_1.root 1 fillZll=true,skim_met_ZllEvt=50,skim_nGoodLep=2,fillPhoton=true
# ./runBabyMaker stopbaby 1000 3 ./ /hadoop/cms/store/group/snt/run2_mc2016/ttH_HToInvisible_M125_13TeV_powheg_pythia8_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1_MINIAODSIM_CMS4_V10-02-05/merged_ntuple_1.root 0 
./runBabyMaker stopbaby 1000 3 ./ /hadoop/cms/store/group/snt/run2_mc2017/ttH_HToInvisible_M125_13TeV_TuneCP5_powheg_pythia8_RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1_MINIAODSIM_CMS4_V10-02-05/merged_ntuple_14.root 0 
./runBabyMaker stopbaby 1000 3 ./ /hadoop/cms/store/group/snt/run2_mc2018/ttH_HToInvisible_M125_TuneCP5_PSweights_13TeV_powheg_pythia8_RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1_MINIAODSIM_CMS4_V10-02-04/merged_ntuple_10.root 0 
