...
cp -rL *.so LinkDef_rdict.pcm btagsf jecfiles json_files lepsf puWeights_2016data_36p6fbinv.root xsec_*.root scale1fbs*.txt runBabyMaker doTest.sh $BATCH_DIR/input
