...
cp -r *.so LinkDef_rdict.pcm btagsf jecfiles json_files lepsf TopTagger puWeights_2016data_36p6fbinv.root scale1fbs.txt runBabyMaker sample_2017.dat $BATCH_DIR/input
popd > /dev/null
