...
cp -rL *.so LinkDef_rdict.pcm btagsf jecfiles json_files lepsf TopTagger puWeights_2016data_36p6fbinv.root xsec_stop_13TeV.root scale1fbs.txt *.pb runBabyMaker sample_2017.dat doTest.sh $BATCH_DIR/input
popd > /dev/null
