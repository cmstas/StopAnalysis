...
// makeCMS3ClassFiles("/home/users/sicheng/working/StopAnalysis/StopBabyMaker/SMS_stopbaby_3.root", "t", "stop_1l_babyAnalyzer", "stop_1l", "babyAnalyzer")
...
class stop_1l_babyAnalyzer {
 ...
 protected: 
  ...
  vector<float> *ak8pfjets_softdrop_mass_;
  TBranch *ak8pfjets_softdrop_mass_branch;
  bool     ak8pfjets_softdrop_mass_isLoaded;
  ...
  vector<float> *jup_ak8pfjets_top_mass_;
  TBranch *jup_ak8pfjets_top_mass_branch;
  bool     jup_ak8pfjets_top_mass_isLoaded;
  vector<float> *jup_ak8pfjets_pruned_mass_;
  TBranch *jup_ak8pfjets_pruned_mass_branch;
  bool     jup_ak8pfjets_pruned_mass_isLoaded;
  vector<float> *jup_ak8pfjets_trimmed_mass_;
  TBranch *jup_ak8pfjets_trimmed_mass_branch;
  bool     jup_ak8pfjets_trimmed_mass_isLoaded;
  vector<float> *jup_ak8pfjets_filtered_mass_;
  TBranch *jup_ak8pfjets_filtered_mass_branch;
  bool     jup_ak8pfjets_filtered_mass_isLoaded;
  vector<float> *jup_ak8pfjets_softdrop_mass_;
  TBranch *jup_ak8pfjets_softdrop_mass_branch;
  bool     jup_ak8pfjets_softdrop_mass_isLoaded;
  vector<float> *jup_ak8pfjets_pu_id_;
  TBranch *jup_ak8pfjets_pu_id_branch;
  bool     jup_ak8pfjets_pu_id_isLoaded;
  ...
  vector<float> *jdown_ak8pfjets_top_mass_;
  TBranch *jdown_ak8pfjets_top_mass_branch;
  bool     jdown_ak8pfjets_top_mass_isLoaded;
  vector<float> *jdown_ak8pfjets_pruned_mass_;
  TBranch *jdown_ak8pfjets_pruned_mass_branch;
  bool     jdown_ak8pfjets_pruned_mass_isLoaded;
  vector<float> *jdown_ak8pfjets_trimmed_mass_;
  TBranch *jdown_ak8pfjets_trimmed_mass_branch;
  bool     jdown_ak8pfjets_trimmed_mass_isLoaded;
  vector<float> *jdown_ak8pfjets_filtered_mass_;
  TBranch *jdown_ak8pfjets_filtered_mass_branch;
  bool     jdown_ak8pfjets_filtered_mass_isLoaded;
  vector<float> *jdown_ak8pfjets_softdrop_mass_;
  TBranch *jdown_ak8pfjets_softdrop_mass_branch;
  bool     jdown_ak8pfjets_softdrop_mass_isLoaded;
  vector<float> *jdown_ak8pfjets_pu_id_;
  TBranch *jdown_ak8pfjets_pu_id_branch;
  bool     jdown_ak8pfjets_pu_id_isLoaded;
...
void LoadAllBranches(); 
  ...
  const vector<float> &ak8pfjets_softdrop_mass();
  ...
  const vector<float> &jup_ak8pfjets_top_mass();
  const vector<float> &jup_ak8pfjets_pruned_mass();
  const vector<float> &jup_ak8pfjets_trimmed_mass();
  const vector<float> &jup_ak8pfjets_filtered_mass();
  const vector<float> &jup_ak8pfjets_softdrop_mass();
  const vector<float> &jup_ak8pfjets_pu_id();
  ...
  const vector<float> &jdown_ak8pfjets_top_mass();
  const vector<float> &jdown_ak8pfjets_pruned_mass();
  const vector<float> &jdown_ak8pfjets_trimmed_mass();
  const vector<float> &jdown_ak8pfjets_filtered_mass();
  const vector<float> &jdown_ak8pfjets_softdrop_mass();
  const vector<float> &jdown_ak8pfjets_pu_id();
