...
std::tuple<int,int,unsigned> getDMMassesByLumi(int type, int year, unsigned lumi) {
  ...
  if (!lmmap || !memap) {
    std::string fname;
    if (type == 1) {
      if (year == 2016) fname = "../StopCORE/inputs/configs/TTbarDMJets_Inclusive_scalar_RunIISummer16NanoAODv7_masses.txt";
      if (year == 2017) fname = "../StopCORE/inputs/configs/TTbarDMJets_Inclusive_scalar_RunIIFall17NanoAODv7_masses.txt";
      if (year == 2018) fname = "../StopCORE/inputs/configs/TTbarDMJets_Inclusive_scalar_RunIIAutumn18NanoAODv7_masses.txt";
    } else if (type == -1) {
      if (year == 2016) fname = "../StopCORE/inputs/configs/TTbarDMJets_Inclusive_pseudoscalar_RunIISummer16NanoAODv7_masses.txt";
      if (year == 2017) fname = "../StopCORE/inputs/configs/TTbarDMJets_Inclusive_pseudoscalar_RunIIFall17NanoAODv7_masses.txt";
      if (year == 2018) fname = "../StopCORE/inputs/configs/TTbarDMJets_Inclusive_pseudoscalar_RunIIAutumn18NanoAODv7_masses.txt";
    }
